...
export default class Import extends React.Component {
    ...
    render() {
        return (
            <div>
                <Paper style={{width: 400, height: 200, padding: 10, float: "left"}} zDepth={1}>
                    <SelectField floatingLabelText="Plese select template"
                                 ...
                                 onChange={this.handleSelectedTemplate}>
                        {
                            Object.keys(this.props.templateList).map(templateName => {
                                return (
                                    <MenuItem key={templateName} value={templateName} primaryText={templateName}/>
                                )
                            })
                        }
                ...
                <Paper style={{marginLeft: 10, width: 900, height: 200, padding: 10, float: "left"}} zDepth={1}>
                    <table className="excelFileInfo">
                        ...
                        <tr>
                            ...
                            <td><span className="infoTitle">Number of sheets:</span> {this.state.excelFile.noOfSheets}
                            </td>
                            <td><span
                        ...
                        <tr>
                            ...
                            <td><span
                                className="infoTitle">Sheet to import:</span> {this.state.selectedTemplate.sheetNo}</td>
                        </tr>
                        <tr>
                            <td><RaisedButton
                                labelStyle={{fontWeight: "bold"}}
                ...
                <Paper style={{marginTop: 10, width: 1310, height: 200, padding: 10, float: "left"}} zDepth={1}>
